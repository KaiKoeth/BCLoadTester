...
public partial class LoadTestDashboard : Form
{
    ...
    private async void btnStart_Click(object sender, EventArgs e)
    {
        ...
        var workerFactoryResult = WorkerFactory.CreateWorkers(
            _config,
            _client,
            new WorkerDataContext(
                _customerPools,
                _invoiceCustomerNoCache,
                _creditMemoCustomerNoCache,
                _orderStatusCache,
                _webOrderPoolCache),
            _statisticsService,
            _dynamicConcurrency);

        var workers = workerFactoryResult.Workers;
        _workerCounts = workerFactoryResult.WorkerCounts;
        btnReset.Enabled = false;
